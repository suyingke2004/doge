...
DEEPSEEAK_API_KEY=your_deepseek_api_key_here
...
#### 5.1 多轮对话
应用支持多轮对话，可以在生成内容后继续提问以获取更多细节。

#### 5.2 模型选择
支持多种AI模型提供商和具体模型，可以根据需求选择最适合的模型。

#### 5.3 最大迭代次数
可以设置代理执行的最大迭代次数，控制信息搜集的深度。

#### 5.4 内容交付
支持将生成的内容通过邮件发送或导出为PDF文件。
